  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          const Card(child: ListTile(leading: CircleAvatar(child: Icon(Icons.business_center_outlined)), title: Text('Business Operations'), subtitle: Text('Manage sales, production, stock, cash, expenses, salary, capital and history.'))),
          const SizedBox(height: 18),
          ...items.map((x) => Padding(
            padding: const EdgeInsets.only(bottom: 10),
            child: Card(child: ListTile(
              contentPadding: const EdgeInsets.symmetric(horizontal: 16, vertical: 8),
              leading: CircleAvatar(radius: 24, child: Icon(x.icon)),
              title: Text(x.title, style: const TextStyle(fontWeight: FontWeight.w600)),
