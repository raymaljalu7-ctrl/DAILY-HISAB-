  ...
  Future<void> _saveProduction(
    ...
    if (entries.isEmpty) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text(
            'Add at least one product to production.',
          ),
        ),
      );
      return;
    ...
    try {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text(
            '${entries.length} production item(s) saved successfully.',
          ),
        ),
      );
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              SizedBox(height: 6),
              Text(
                'Add products in Products Master before entering production.',
                textAlign: TextAlign.center,
              ),
            ],
          ),
