...
import 'screens/reports_page.dart' as reports;
...
class WelcomePage extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final isRetail = profile['role'] == 'retail_shop_user';
    if (isRetail) {
    ...
    final items = <NavBox>[
      ...
      NavBox('REPORT', 'Reports & PDF', Icons.assessment_outlined, teal, () => const reports.ReportsPage()),
    ];
    if (profile['role'] == 'admin') {
      items.add(NavBox('ADMIN', 'Users & approvals', Icons.admin_panel_settings_outlined, orange, () => const AdminPage()));
    }
      ...
      child: InkWell(
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              CircleAvatar(radius: 27, backgroundColor: item.color, child: Icon(item.icon, color: Colors.white, size: 28)),
              const SizedBox(height: 10),
              Text(item.title, textAlign: TextAlign.center, style: TextStyle(fontWeight: FontWeight.bold, color: item.color, fontSize: 15)),
              const SizedBox(height: 4),
              Text(item.subtitle, textAlign: TextAlign.center, maxLines: 2, overflow: TextOverflow.ellipsis, style: const TextStyle(fontSize: 11, color: Colors.black54)),
            ],
          ),
        ),
      ),
    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          ...
          _RetailCard(title: 'RETAIL SALES', sub: 'Enter customer sales', icon: Icons.point_of_sale, onTap: () => Navigator.push(context, MaterialPageRoute(builder: (_) => const SalesPage()))),
          ...
          const SizedBox(height: 12),
          _RetailCard(title: 'REPORTS', sub: 'View your shop reports', icon: Icons.assessment, onTap: () => Navigator.push(context, MaterialPageRoute(builder: (_) => const reports.ReportsPage()))),
        ],
      ),
    );
  }
